<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-4">
        <div class="infocard" v-if="!$root.DBexists">
          <p>You currently have a project open</p>
          <button @click="$router.push('home')" class="btn btn-success">
            Continue Working
          </button>
        </div>
      </div>
      <div class="col-12 col-sm-4">
        <div class="infocard">
          ...
          <button class="btn btn-success"><i class="mdi mdi-folder-plus md-24 "></i> New Project</button>
        </div>
      </div>
    </div>
