...
<div class="columns is-tablet">
  <div class="column is-half-tablet is-offset-one-quarter ">
   <div  v-for="(mindmap, index) in $root.shadowDB.Mindmap"  :key="index" >


<div class="card">

  <div class="card-content">
       <button  @click="DeleteMe(mindmap.uuid)" class="button wm_button_icon is-danger" style="position:absolute; top:10px; right:10px;" ><i class="mdi mdi-delete md-24"></i></button>
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">{{ mindmap.title }}</p>
      </div>
    </div>
  ...
  <button  @click="$router.push('/Mindmap/' + mindmap.uuid)"  class="button is-success card-footer-item"
...
<div :class="'modal '+showmodal">
  ...
  <div class="modal-card">
    <header class="modal-card-head">
      <p class="modal-card-title">New Mindmap</p>
      <button class="delete" aria-label="close" @click="toggleModal"></button>
    </header>
    <section class="modal-card-body">
     <label>Title</label>
   <input class="input is-small" type="text" placeholder="title ..." v-model="newMindmap.title">

     <label>Summary</label>
     <textarea class="textarea is-small" placeholder="type here ..." v-model="newMindmap.description"></textarea>
